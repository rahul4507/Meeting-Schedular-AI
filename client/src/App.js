...
const data = [
  { name: "Rahul", surname: "Hiragond" },
  { name: "Akash", surname: "Panse" },
];
const App = () => (
  <>
    <React.Fragment>
      ...
      <Router>
        <Switch>
          ...
          <Route path="/my-groups">
            <Profile
              redirectPath="/login"
              content={<Drawer content={<MyGroupsPage />} />}
            />
          </Route>
          ...
          <Route path="/add-member">
            <Profile
              redirectPath="/login"
              content={<Drawer content={<AddGroupMemberPage />} />}
            />
          </Route>
          ...
          <Route path="/settings">
            <Profile
              redirectPath="/login"
              content={<Drawer content={<SettingsPage />} />}
            />
          </Route>
