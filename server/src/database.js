...
const dbConnectionURL = {
  URL: `mongodb+srv://admin:admin@cluster.gy94o.mongodb.net/?retryWrites=true&w=majority&appName=Cluster`,
};
...
db.on(
  "error",
  console.error.bind(console, "Mongodb Connection Error:" + dbConnectionURL.URL)
);
db.once("open", () => {
  // we're connected !
